                ...
                <div className='row d-flex justify-content-center pt-4'>
                    ...
                    <div style={{borderRadius: '10px', margin: '10px'}} className='col-md-3 box border'>
                        ...
                        <div className='row d-flex' style={{margin: '10px', fontSize: '30px'}}>
                            <p className='primary' style={{fontSize: '15px'}}> V2.00 focused on a pivotal shift in terms of team development and management, as well as S3 transition from AWS to CloudFlare.</p>
                            <br></br>
                          <div className='col-md-12 d-flex flex-wrap' style={{marginTop: '10px'}}>
                            <div style={{fontSize: '10px'}}><p className='interest-pill'>Team Development</p></div>
                            <div style={{fontSize: '10px'}}><p className='interest-pill'>AWS S3</p></div>
