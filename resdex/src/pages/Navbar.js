...
const Navbar = () => {
      ...
      <div className="collapse navbar-collapse" id="navbarSupportedContent">
        <ul className="navbar-nav ms-auto">
          <li className="nav-item">
            ...
            <span className='primary' style={{padding: 'none', margin: 'none'}}>Home</span>
  ...
  <path d="M6.5 14.5v-3.505c0-.245.25-.495.5-.495h2c.25 0 .5.25.5.5v3.5a.5.5 0 0 0 .5.5h4a.5.5 0 0 0 .5-.5v-7a.5.5 0 0 0-.146-.354L13 5.793V2.5a.5.5 0 0 0-.5-.5h-1a.5.5 0 0 0-.5.5v1.293L8.354 1.146a.5.5 0 0 0-.708 0l-6 6A.5.5 0 0 0 1.5 7.5v7a.5.5 0 0 0 .5.5h4a.5.5 0 0 0 .5-.5"/>
          ...
          <li className="nav-item">
            ...
            <span className='primary' style={{padding: 'none', margin: 'none'}}>Search</span>
  ...
  <path d="M11.742 10.344a6.5 6.5 0 1 0-1.397 1.398h-.001q.044.06.098.115l3.85 3.85a1 1 0 0 0 1.415-1.414l-3.85-3.85a1 1 0 0 0-.115-.1zM12 6.5a5.5 5.5 0 1 1-11 0 5.5 5.5 0 0 1 11 0"/>
          ...
          <li className="nav-item">
            ...
            <span className='primary' style={{padding: 'none', margin: 'none'}}>Notifications</span>
  ...
  <path d="M8 16a2 2 0 0 0 2-2H6a2 2 0 0 0 2 2m.995-14.901a1 1 0 1 0-1.99 0A5 5 0 0 0 3 6c0 1.098-.5 6-2 7h14c-1.5-1-2-5.902-2-7 0-2.42-1.72-4.44-4.005-4.901"/>
          ...
          {user && username && (
            <li className="nav-item">
              ...
              <span className='primary' style={{padding: 'none', margin: 'none'}}>Profile</span>
          ...
          <li className="nav-item">
            {user ? (
              <NavLink to="/login" className="nav-link" onClick={handleLogout}>
                              <span className='primary' style={{padding: 'none', margin: 'none'}}>Logout</span>
              ...
              <span className='primary' style={{padding: 'none', margin: 'none'}}>Login</span>
