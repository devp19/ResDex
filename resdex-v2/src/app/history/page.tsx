          ...
          <aside className="lg:col-span-2">
            <div className="sticky top-24 space-y-6">
              <nav className="space-y-2">
                ...
                <a href="/history" className="flex items-center gap-3 px-3 py-2 rounded-lg bg-blue-50 dark:bg-blue-900/20 text-blue-700 dark:text-blue-300 font-medium">
                  <svg className="h-5 w-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <div className="p-6">
                      ...
                      <div className="flex items-center justify-between">
                        ...
                        <div className="flex items-center gap-1 text-neutral-400 group-hover:text-blue-500 transition-colors">
                          <span className="text-sm font-medium">Read again</span>
                          <svg className="h-4 w-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
