...
const features = [
  {
    icon: (
      <svg width="32" height="32" fill="none" viewBox="0 0 24 24">
        <circle cx="12" cy="12" r="10" stroke="#101828" strokeWidth="2" />
        <path
          d="M8 12h8M12 8v8"
          stroke="#101828"
          strokeWidth="2"
    ...
    icon: (
      <svg width="32" height="32" fill="none" viewBox="0 0 24 24">
        <rect
          ...
          strokeWidth="2"
        />
        <path d="M8 16v-4a4 4 0 118 0v4" stroke="#101828" strokeWidth="2" />
      </svg>
    ),
    title: "Portfolio",
  ...
  },
  {
    icon: (
      <svg width="32" height="32" fill="none" viewBox="0 0 24 24">
        <circle cx="8" cy="12" r="3" stroke="#101828" strokeWidth="2" />
        <circle cx="16" cy="12" r="3" stroke="#101828" strokeWidth="2" />
        <path
          d="M8 15c-2.5 0-4 1.5-4 3v1h8v-1c0-1.5-1.5-3-4-3zm8 0c-2.5 0-4 1.5-4 3v1h8v-1c0-1.5-1.5-3-4-3z"
          stroke="#101828"
          strokeWidth="2"
        />
      </svg>
...
function TestimonialCard({
  ...
  return (
    <div
      className="bg-[#f7f7f8] rounded-xl p-6 max-w-sm min-h-[220px] flex flex-col items-start justify-between"
  ...
  return (
    <section className="w-full flex flex-col items-center justify-center py-32 bg-white">
      <h2
        ...
        style={{ fontFamily: "GellixMedium, sans-serif", lineHeight: 1.15 }}
      >
        Used by 10,000+ businesses, creators,
...
export default function CanopyDemo() {
  ...
  return (
    <div className="min-h-screen bg-white relative overflow-hidden">
      <AlertDialog open={open} onOpenChange={setOpen}>
        ...
        <AlertDialogContent>
          <AlertDialogHeader>
            ...
            <AlertDialogDescription>
              We appreciate your interest in ResDex. As we are still in
              development, we currently have limited access. Until then, feel
              free to check out the site and what ResDex is all about! <br></br>{" "}
              <br></br>Please join our{" "}
              <a href="/waitlist" style={{ textDecoration: "underline" }}>
                waitlist
              </a>{" "}
              to be notified when we launch and gain access to the platform as
              soon as we are ready to go public!
              <br></br>
              <br></br>
            </AlertDialogDescription>
          </AlertDialogHeader>
          <AlertDialogFooter>
            ...
            <AlertDialogAction onClick={() => router.push("/waitlist")}>
              Join Waitlist
            </AlertDialogAction>
          </AlertDialogFooter>
        </AlertDialogContent>
      ...
      {/* Hero Section */}
      <section
        className="relative flex flex-col items-center justify-center min-h-[calc(100vh-100px)] flex-1 -mt-12"
        style={{
          fontFamily: "GellixMedium, sans-serif",
      ...
      >
        ...
        <div className="relative z-10 w-full flex flex-col items-center">
          ...
          >
            The new way to explore, connect, and stay updated with the latest in
          ...
          >
            <motion.a
              ...
              onMouseOut={(e) =>
                (e.currentTarget.style.background = PRIMARY_BTN_BG)
              }
              variants={{
      ...
      <section className="w-full flex flex-col items-center justify-center py-32 bg-[#FAFAF8] relative overflow-hidden">
        {/* Maze SVG background */}
        <svg
          className="absolute left-[-15%] top-0 w-[70%] h-full z-0 pointer-events-none"
          width="70%"
          height="100%"
          viewBox="0 0 800 400"
          fill="none"
        ...
        >
          ...
          <g opacity="0.07" mask="url(#maze-mask)">
            <path
              d="M 100 50 Q 200 100 100 150 Q 0 200 100 250 Q 200 300 100 350"
              stroke="#101117"
              strokeWidth="2"
              fill="none"
            />
            <path
              d="M 300 50 Q 400 100 300 150 Q 200 200 300 250 Q 400 300 300 350"
              stroke="#101117"
              strokeWidth="2"
              fill="none"
            />
            <path
              d="M 500 50 Q 600 100 500 150 Q 400 200 500 250 Q 600 300 500 350"
              stroke="#101117"
              strokeWidth="2"
              fill="none"
            />
            <path
              d="M 700 50 Q 800 100 700 150 Q 600 200 700 250 Q 800 300 700 350"
              stroke="#101117"
              strokeWidth="2"
              fill="none"
            />
        ...
        <div className="max-w-4xl w-full flex flex-col items-start justify-center px-4 mx-auto relative z-10">
          <BlurFade delay={0.1} inView>
            <span className="uppercase tracking-widest text-xs text-gray-400 mb-6 satoshi-medium">
              ResDex
            </span>
          </BlurFade>
          <BlurFade delay={0.15} inView>
            <h1 className="text-5xl md:text-6xl font-bold text-gray-900 mb-2 satoshi-bold text-left">
              Finding research shouldn't feel like a{" "}
              <span className="satoshi-bold-italic">maze</span>.{" "}
              <span className="text-5xl md:text-6xl font-bold text-gray-500 mb-8 satoshi-bold text-left">
                {" "}
                Now it doesn't.
              </span>
            </h1>
      ...
      >
        <div className="w-full max-w-7xl mx-auto px-8">
          <BlurFade delay={0.1} inView>
            <div className="uppercase text-xs tracking-widest text-gray-400 mb-4 satoshi-medium">
              Discover, showcase, and collaborate on research — all in one
              place.
            </div>
          </BlurFade>
          <BlurFade delay={0.15} inView>
        ...
        <div className="w-full overflow-x-auto pb-8 px-32 custom-scrollbar">
          <div
            className="flex flex-row gap-8 min-w-[900px]"
            style={{ width: "max-content" }}
          >
            {/* Card 1 */}
            <div
              className="bg-[#181922] rounded-2xl p-8 min-w-[350px] max-w-[400px] flex flex-col justify-between shadow-lg border border-[#23242c] relative"
              style={{ height: "320px" }}
            >
              <div className="flex items-center justify-between mb-8">
                <div className="flex items-center gap-2">
                  <FaUser size={22} color="#fff" />
                  <span className="text-xs tracking-widest text-gray-200 satoshi-medium">
                    RESDEX PROFILES
                  </span>
                </div>
              ...
              <div className="flex-1 flex flex-col justify-end">
                <div className="text-2xl font-semibold text-white mb-2 satoshi-bold leading-snug">
                  Build your research identity.
                </div>
                <div className="text-gray-400 text-sm mt-2 satoshi-medium">
                  Create a professional research profile to showcase your work,
                  papers, and projects. ResDex makes you discoverable by peers,
            ...
            >
              ...
              <div className="flex-1 flex flex-col justify-end">
                ...
                <div className="text-gray-400 text-sm mt-2 satoshi-medium">
                  Join or start research projects. ResDex helps you find
                  collaborators, share updates, and manage academic work with
                  your team.
                </div>
              </div>
            </div>
            ...
            >
              ...
              <div className="flex-1 flex flex-col justify-end">
                <div className="text-2xl font-semibold text-white mb-2 satoshi-bold leading-snug">
                  Surface the opportunities that matter.
                </div>
                <div className="text-gray-400 text-sm mt-2 satoshi-medium">
                  Get matched with labs, supervisors, and open calls for papers.
                  ResDex curates recommendations based on your interests and
                  activity.
                </div>
              </div>
            </div>
            ...
            >
              <div className="flex items-center justify-between mb-8">
                <div className="flex items-center gap-2">
                  ...
                  <span className="text-xs tracking-widest text-gray-300 satoshi-medium">
                    KEYNOTE SESSIONS
                  </span>
                </div>
                <button className="w-8 h-8 rounded-full bg-[#23242c] flex items-center justify-center text-gray-300 hover:bg-[#23242c]/80 transition">
              ...
              <div className="flex-1 flex flex-col justify-end">
                <div className="text-2xl font-semibold text-white mb-2 satoshi-bold leading-snug">
                  Join us for live keynote sessions.
                </div>
                <div className="text-gray-400 text-sm mt-2 satoshi-medium">
                  Hear directly from the ResDex team at conferences, student
                  showcases, and AMAs. We talk about research, student success,
                  and what’s next in academia.
                </div>
              </div>
            </div>
            ...
            >
              ...
              <div className="flex-1 flex flex-col justify-end">
                ...
                <div className="text-gray-400 text-sm mt-2 satoshi-medium">
                  Use our intelligent match system to connect with faculty,
                  researchers, and peers aligned with your interests and goals.
                </div>
              </div>
            </div>
            ...
            >
              ...
              <div className="flex-1 flex flex-col justify-end">
                <div className="text-2xl font-semibold text-white mb-2 satoshi-bold leading-snug">
                  Stay updated with research events.
                </div>
                <div className="text-gray-400 text-sm mt-2 satoshi-medium">
                  Discover conferences, calls for papers, funding deadlines, and
                  workshops; all personalized to your academic interests.
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="flex flex-col md:flex-row gap-8 w-full max-w-5xl mx-auto justify-center">
          ...
          <div className="flex-1 bg-[#F5F5F5] rounded-2xl flex flex-col items-center p-8 min-w-[320px]">
            <div className="w-[220px] h-[400px] bg-black rounded-xl flex items-center justify-center mb-8 overflow-hidden">
              ...
              >
                <source
                  src="/video-shortform-home-avc.mp4"
                  type='video/mp4; codecs="avc1.42E01E, mp4a.40.2"'
                />
              </video>
            </div>
            <div className="w-full">
              <div className="text-lg font-bold satoshi-bold mb-2">
                Short-Form
              </div>
              <div className="text-gray-500 text-base satoshi-medium">
                We know you love scrolling, so we made it easy to share and
                discover research videos. From short-form clips to in-depth
                lectures, ResDex has you covered.
              </div>
            </div>
          </div>
          {/* Card 2 */}
          <div className="flex-1 bg-[#F5F5F5] rounded-2xl flex flex-col items-center p-8 min-w-[320px]">
            <div className="w-[220px] h-[400px] bg-black rounded-xl flex items-center justify-center mb-8 overflow-hidden">
              ...
              >
                <source
                  src="/topics-shortform-home-avc.mp4"
                  type='video/mp4; codecs="avc1.42E01E, mp4a.40.2"'
                />
              </video>
            </div>
            <div className="w-full">
              ...
              <div className="text-gray-500 text-base satoshi-medium">
                No more noise. Customize your ResDex experience to see the
                topics, researchers, and projects that matter most to you.
          ...
          <div className="flex flex-col md:flex-row gap-12 w-full max-w-6xl mx-auto justify-center items-start md:items-stretch">
            ...
            <div className="flex-1 flex flex-col items-start text-left px-4">
              <span className="inline-flex items-center px-4 py-2 mb-6 rounded-lg bg-[#f5f5f5] text-[#181818] font-semibold satoshi-medium text-sm">
                <svg
                  ...
                  viewBox="0 0 24 24"
                >
                  <path d="M17 20h5v-2a4 4 0 00-3-3.87M9 20H4v-2a4 4 0 013-3.87M12 12a4 4 0 100-8 4 4 0 000 8zm0 0v4m0 4h.01" />
                </svg>
                Researchers
              </span>
              <div className="relative flex items-baseline mb-2 mt-2">
                <span className="text-7xl font-medium gellix-medium leading-none">
                  {" "}
                  8.
                  <NumberTicker value={9} startValue={0} />M
                </span>
                <span className="absolute right-[-1.5rem] top-0 text-lg font-bold satoshi-bold text-gray-500">
                  +
                </span>
              </div>
              <div className="text-gray-500 text-base satoshi-medium">
                Researchers worldwide that ResDex can impact positively.
              </div>
            </div>
            {/* Stat 2 */}
            ...
            <div className="flex-1 flex flex-col items-start text-left px-4">
              ...
              <div className="relative flex items-baseline mb-2 mt-2">
                <span className="text-7xl font-medium gellix-medium leading-none">
                  {" "}
                  <NumberTicker value={300} startValue={150} />
                </span>
                <span className="absolute right-[-2.9rem] bottom-0 text-lg text-gray-500">
                  times
                </span>
              </div>
              <div className="text-gray-500 text-base satoshi-medium">
                More likely to get responses when contacted via verified
                profiles.
              </div>
            </div>
          </div>
      ...
      <section className="w-full flex flex-col items-center justify-center py-24 bg-transparent">
        <BlurFade delay={0.1} inView>
          <div
            className="relative bg-[#101117] rounded-3xl shadow-xl max-w-4xl w-full mx-auto px-8 py-20 flex flex-col items-center justify-center"
          ...
          >
            ...
            <div className="relative z-10 flex flex-col items-center justify-center text-center">
              <BlurFade delay={0.1} inView>
                <h2
                  className="text-3xl md:text-5xl font-bold mb-4 satoshi-bold"
                  style={{ color: "#fff" }}
                >
                  We're building the biggest research hub in the world.
                  <br />
              ...
              <BlurFade delay={0.15} inView>
                <p className="text-gray-300 text-md max-w-xl mb-8 mt-8 satoshi-medium">
                  Purpose built for students and researchers, our modern
                  platform lets you discover, connect, and grow your academic
                  impact with ease.
                </p>
              </BlurFade>
              <BlurFade delay={0.2} inView>
